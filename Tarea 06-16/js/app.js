...
function cargarTabla()
  ...
  //  console.log("personas ->"+personas);
    ...
    for (var i = 0; i < personas.length; i++) {
        console.log("girando");
        salida=salida+"<tr><td>"+i+"</td><td>"+personas[i].docnro+"</td><td>"+personas[i].apellido+"</td><td>"+personas[i].nombre+"</td><td>"+personas[i].fenac+"</td> <td><a class='btEditar btn btn-warning ' data-idx='"+i+"'>Editar</a></td> <td><a class='btBorrar btn btn-danger ' data-idx='"+i+"'>Borrar</a></td></tr>"
        //console.log(salida);
      }
...
function pruebas()
   {
     ...
     for (var i = 0; i < botones.length; i++) {
       botones[i].classList.add("btn-info");
     }
